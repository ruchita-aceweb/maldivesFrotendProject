        ...
        <>
            <div>
                <div className="w-full xl:w-1/4">
                    ...
                    {/* <button
  className="flex justify-center rounded-xl bg-success p-2 text-sm font-medium text-white mb-4"
  onClick={backBooking}
>
  BACK
</button> */}
                        ...
                        <div className="flex gap-5.5">
                            ...
                            <div className="flex-col flex-1">
                                ...
                                <div className="flex gap-2"> {/* Added flex container for buttons and input */}
                                    {/* <button className="px-2 py-2 border rounded-md bg-secondary" onClick={minusAdults}>-</button> */}
                                    <img
                          src={Decrement}
                         alt="Decrement"
                         className="px-1 py-1 " onClick={minusAdults}
                            />
                                    <input
                                        ...
                                        type=""
                                        placeholder="Adults"
                                        className=" text-black w-7 rounded-lg border-[1.5px] border-stroke bg-transparent py-2 px-2 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                                    />
                                    {/* <button className="px-2 py-2 border rounded-md bg-success" onClick={plusAdults}>+</button> */}
                                    <img
                          src={Increment}
                         alt="Increment"
                         className="px-1 py-1 "   onClick={plusAdults}
                            ...
                            <div className="flex-col flex-1">
                                ...
                                <div className="flex gap-2"> {/* Added flex container for buttons and input */}
                                {/* <button className="px-2 py-2 border rounded-md bg-secondary text-black" onClick={minusKids}>
                                    -</button> */}
                         ...
                         className="px-1 py-1" onClick={minusKids}
                            />
                                    <input
                                        ...
                                        type=""
                                        placeholder="Kids"
                                        className="w-7  text-black rounded-lg border-[1.5px] border-stroke bg-transparent py-2 px-2 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                                    />
                                    {/* <button className="px-2 py-2 border rounded-md  bg-success" onClick={plusKids}>+</button> */}
                                    <img
                          src={Increment}
                         alt="Increment"
...
<button
  className={`flex justify-center px-6 rounded-xl bg-green-500 p-2 text-sm font-medium text-white mb-4 ${loadingApprove ? 'cursor-not-allowed' : ''}`}
  style={{
    borderRadius: '20px',
    fontWeight: 'medium',
    color: 'white',
    backgroundColor: loadingApprove ? '#808080' : '#32914a',
