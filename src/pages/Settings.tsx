             ...
             <form action="#">
               <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                 <div className="w-full sm:w-1/2">
                   ...
                   <div className="relative">
                     <input
                       className="w-full rounded text-sm border border-stroke bg-gray py-3 pl-11.5 pr-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                       type="text"
                       id="first_name"
               ...
               <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                 <div className="w-full sm:w-1/2">
                   ...
                   <div className="relative">
                     <input
                       className="w-full text-sm rounded border border-stroke bg-gray py-3 pl-11.5 pr-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                       type="text"
               ...
               <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                 ...
                 <div className="w-full sm:w-1/2">
                   ...
                   <select
                     ...
                     className="w-full text-sm rounded-lg border border-stroke bg-transparent py-3 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                   >
               ...
               <div className="flex justify-end gap-4.5">
                 <button
                   className="flex justify-center text-xs py-2 px-6 font-medium text-black hover:shadow-1  dark:text-white"
                   type="submit"
                 ...
                 <button
                   className="flex justify-center rounded-full bg-primary py-2 text-sm px-6 font-medium text-gray hover:shadow-1"
                   type="submit"
           ...
           <div className="p-7">
             ...
             <form action="#">
               ...
               <div className="flex justify-end gap-4.5">
                 ...
                 <button
                   className="flex justify-center rounded-full text-xs bg-primary py-2 px-6 font-medium text-gray hover:bg-opacity-70"
                   type="submit"
