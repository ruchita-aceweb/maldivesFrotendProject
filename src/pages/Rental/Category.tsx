...
const [values, setValues] = useState<FormValues>(initialFValues);
  ...
  return (
    ...
    <button className="flex font-medium w-30 text-xs mt-auto justify-center rounded-full bg-danger px-1 py-1 pr-2  text-white " onClick={addCategory}>
    <span className="mt-0.5 text-white  "><IoMdAdd /></span>  Add Category
    </button>
  </div>
