              ...
              <table className="w-full table-auto">
                <thead >
                  <tr className="bg-gray-2 text-left dark:bg-meta-4">
                    ...
                    <th className="min-w-[100px] py-4 px-4 text-bold text-black dark:text-white ">
                      Title
                    </th>
                    <th className="min-w-[20px] py-4 px-4 text-bold text-black dark:text-white ">
                      Document
                    </th>
                    <th className="min-w-[150px] py-4 px-4 text-bold text-black dark:text-white">
                      Property Type
                    </th>
                    <th className="min-w-[120px] py-4 px-4 text-bold text-black dark:text-white">
                      Property Category
                    </th>
                ...
                <div className="relative w-auto my-6 mx-auto max-w-3xl">
                  ...
                  <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                    ...
                    <div className="flex items-center justify-end p-6 border-t border-solid border-blueGray-200 rounded-b">
                      ...
                      <button
                        className=" text-white active:bg-blue-600 font-bold  text-sm px-6 py-2 rounded-full bg-danger hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                        type="button"
