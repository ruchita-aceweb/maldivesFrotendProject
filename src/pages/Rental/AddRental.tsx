    ...
    <>
      ...
      {permission &&
        <div>
          ...
          <div className="flex flex-row justify-end gap-5.5 mt-4">
  <button className="flex justify-center  text-item-center rounded-full px-5 bg-black p-2 text-xs font-medium text-white mb-4" onClick={backSRental}>
    BACK RENTAL
  </button>

<button
  className={`flex justify-center px-6 rounded-xl bg-green-500 p-2 text-sm font-medium text-white mb-4 ${loading ? 'bg-gray-500 cursor-not-allowed' : 'bg-black'}`}
  style={{
    borderRadius: '20px',
    fontWeight: 'medium',
    color: 'white',
    
    backgroundColor: loading ? '#808080' : '#32914a',
