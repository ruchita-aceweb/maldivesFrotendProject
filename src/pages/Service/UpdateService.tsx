    ...
    <span className="mt-0.5 text-white  "><IoMdArrowRoundBack /></span> Back to Service
          ...
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div className="border-b border-stroke py-4 px-6.5 dark:border-strokedark">
              <h3 className=" text-black font-bold dark:text-white">
                New Services Requests
              </h3>
            </div>
            <div className=" gap-5.5 px-6.5 py-3">
              <h6 className="font-bold text-black dark:text-white">
                Details
              </h6>
              <div>
                <label className=" block pt-2 text-black dark:text-white">
                ...
                <div className="flex gap-5.5">
                  <div className="flex-col">
                    ...
                    <input
                      ...
                      className="w-full rounded-lg text-sm border-[1.5px] border-stroke bg-transparent py-3 px-11 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                    />
         ...
         /> */}
                  ...
                  <div className="flex-col">
                    ...
                    <input
                      ...
                      className="w-full text-sm rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-11 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                    />
                  </div>
                  <div className="flex-col">
                    <label className="mb-3 text-sm block text-black dark:text-white">
        ...
        <h1>{newDocument.name}</h1>
            ...
            <div className="flex flex-row gap-5.5 px-6.5 pt-6.5">
            ...
            <div className=''>
            <button className="text-sm justify-center rounded-full bg-primary px-3 py-2 font-medium text-white mb-4" onClick={handleEditSubmit}>
              Submit
            </button>
            </div>
<div>
            <button className=" text-sm justify-center rounded-full bg-secondary px-3 py-2 font-medium text-white mb-4" onClick={clearData}  >
              Clear
            </button>
            </div>
          </div>
