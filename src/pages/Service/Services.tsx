...
const Services = () => {
    ...
    const addServices = async (event: React.FormEvent) => {
      ...
      async function editService(id: any) {
        ...
        <>
         ...
         <div>
          <div className="w-full xl:w-1/4">
              ...
              {/* <button className="flex w-full justify-center rounded bg-danger p-3 font-medium text-white mb-4"  onClick={addServices}>
              ADD SERVICES
              </button> */}

              <button
  className="flex rounded-xl bg-success p-3 text-sm mb-4 font-medium text-white ml-1"
  onClick={addServices}
>
ADD SERVICES
</button>
        ...
        <table className="w-full table-auto">
          ...
          <tbody>
            <tr>
              ...
              <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                <div className="flex items-center space-x-3.5">
                  <button className="hover:text-primary" onClick={()=>editService('123')}>
                    <svg
            ...
            <tr>
              ...
              <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                <div className="flex items-center space-x-3.5">
                  <button className="hover:text-primary" onClick={()=>editService('456')}>
                    <svg
                      className="fill-current"
                      width="18"
                      height="18"
            ...
            <tr>
              ...
              <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                <div className="flex items-center space-x-3.5">
                  <button className="hover:text-primary" onClick={()=>editService('567')}>
                    <svg
                      className="fill-current"
                      width="18"
                      height="18"
            ...
            <tr>
              ...
              <td className="py-5 px-4">
                <div className="flex items-center space-x-3.5">
                  <button className="hover:text-primary" onClick={()=>editService('1789')}>
                    <svg
                      className="fill-current"
                      width="18"
                      height="18"
