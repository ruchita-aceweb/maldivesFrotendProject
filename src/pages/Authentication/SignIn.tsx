...
const SignIn = () => {
 ...
 const handleSubmit = async(event: React.FormEvent)=>{
  event.preventDefault();
    ...
    await axios.post(`${apiUrl}user/signin`,requestBody).then(response=>{
       ...
       toast.error(error.response.data.status,{theme:'colored'})
         })
  ...
  return (
    ...
    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="flex flex-wrap items-center">
        ...
        <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
         ...
         <input
                 ...
                 onClick={handleSubmit}
                  value="Sign-in to BAA ATOLL"
                  className="w-full cursor-pointer rounded-lg text-1xl p-2 text-black transition hover:bg-opacity-90"
                />
                </div>
            <form>
              <div className="mb-4">
        ...
        <div className="hidden w-full xl:block xl:w-1/2" style={{marginTop:"-29px"}}>
          <div className=" text-center">
           <Link className="mb-5.5 inline-block" to="/">
            ...
            <img className="w-full h-screen object-cover" src={signin} alt="island" />
