...
const DropdownNotification = () => {
  ...
  const getNotification = async () => {
    await axios.get(`${apiUrl}user/notifications`, requestConfig).then(response => {
      console.log(response.data.notifications)
      console.log(response.data.notifications.reverse())
      console.log(response.data.notifications.reverse())
      setNotification(response.data.notifications.reverse())
    }).catch(error => {
      console.log(error)
    })
  ...
  return (
     <div>
      ...
      <Link
        ref={trigger}
        onClick={() => { setDropdownOpen(!dropdownOpen), getNotification() }}
        to="#"
          ...
          {notification.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-xs">{item.created_at}-{item.time}</p>
              </Link>
            );
